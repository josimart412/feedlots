...
<body>
                        ...
                        $(document).ready(function () {
                            ...
                            $('#idanimal').keyup(function () {
                               $("#idTB1").empty()
                                ...
                                if (p != "") {
                                    $.ajax({
                                        url: "consulta_lote.php", //action
                                        type: "POST", //method
                                        data: { "id_lote_compra": p},
                                        dataType: "json",
                                        success: function (respuesta) {
                                            $.each(respuesta, function (key, value) {
                                                $("#idTB1").append("<tr>" +
                                                    ...
                                                    "<td>" + value.peso_promedio + "</td>" +
                                                    "<td>" + value.precio_total + "</td>" +
                                                    "<td>" + value.cantidad_animales + "</td>" +
            ...
            <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                ...
                <div class="modal-content">
                    ...
                    <h5 class="modal-title" id="exampleModalLabel">Lote de compra</h5>
        ...
        <form class="row g-3" method="POST" action="validacionPOST.php" id="formulario_modal">
            <div class="col-6 position-relative">
                <label for="validationTooltip01" class="form-label">Id lote compra</label>
                <input disabled type="text" class="form-control" value="" id="id_lote_compra">
              </div>
            <div class="col-6 position-relative">
              <label for="validationTooltip01" class="form-label">Peso total</label>
              <input type="number" class="form-control" value="" id="peso_total">
            </div>
            <div class="col-6 position-relative">
              <label for="validationTooltip01" class="form-label">Peso promedio</label>
              <input type="number" class="form-control" value="" id="peso_promedio">
            </div>
            <div class="col-6 position-relative">
              <label for="validationTooltip01" class="form-label">Precio total</label>
              <input type="number" class="form-control" value="" id="precio_total">
            </div>
            <div class="col-6 position-relative">
              <label for="validationTooltip01" class="form-label">Cantidad animales</label>
              <input type="number" class="form-control" value="" id="cantidad_animales">
            </div>
            <div class="col-6 position-relative">
              <label for="validationTooltip01" class="form-label">Id vendedor</label>
              <input type="text" class="form-control" value="" id="id_vendedor">
            </div>
        ...
        $(document).ready(function () {
            ...
            $('#enviar_form').click(function(){
               ...
               ///valores del formulario
                ...
                var cantidad_animales = $('#cantidad_animales').val();
                ...
                $.ajax({
                        url: "agregar_lote_compra.php", //action
                        type: "POST", //method
                        data: {"id_lote_compra": id_lote_compra, "peso_total":peso_total, "peso_promedio":peso_promedio, "precio_total":precio_total, "cantidad_animales":cantidad_animales, "id_vendedor":id_vendedor},
                        dataType: "json"
                        })
            })
        })
